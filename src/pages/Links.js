...
export default function Links() {
  return<>
    <div style={{padding: "1%", position: "absolute", left:0, widthL: '100%'}}>

          <Link to="/Projects" style={{color: "white", fontSize: "14px", boxShadow: "rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px"}}  
